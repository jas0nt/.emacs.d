...
#+BEGIN_SRC emacs-lisp
  (use-package aweshell
	...
	(add-hook 'eshell-mode-hook (lambda ()
								  (setq-local company-tabnine-always-trigger nil)
...
#+BEGIN_SRC emacs-lisp
  (my-leader-def
	...
	"to" '((lambda ()
			 (interactive)
			 (let ((buffer-name (format "*term %s*" default-directory)))
			   (unless (get-buffer buffer-name)
				 (set-buffer (term-ansi-make-term buffer-name my-shell))
				 (term-mode)
				 (term-char-mode))
