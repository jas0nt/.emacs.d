...
*** comment
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-comment ()
    [
     ["actions"
...
*** file
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-file ()
    "transient-file"
    [
     ["find-file"
...
*** vc
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-vc ()
    [
     ["actions"
...
*** jump
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-jump ()
    [
     ["goto-char"
...
*** music
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-music ()
    [
     ["♫"
...
*** quit
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-quit ()
    [
     ["❗"
...
*** search
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-search ()
    [
     ["content"
      ("i" "imenu" consult-imenu)
      ("r" "rg" consult-ripgrep)
      ("R" "rg+" deadgrep)
      ("s" "multi-buffer" consult-line-multi)
      ]
...
*** terminal
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-terminal ()
    [
     ["actions"
      ("t" ">_" ansi-term)
      ]
...
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-toggle ()
    [
     ["toggle"
      ("e" "english-helper" toggle-company-english-helper)
...
*** window
#+BEGIN_SRC emacs-lisp
  (define-transient-command my-transient-window ()
    [
     ["nav"
